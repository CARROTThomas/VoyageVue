 ...
 */
final class Version20231004052845 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE info (id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE situation (id INT NOT NULL, country VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, zip_code INT NOT NULL, address VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
